...
@Component
public class CoordinatorController extends RegistryController<Group> {
    ...
    public CoordinatorController(GroupService service, CatequesisService catequesisService) {
        super(service);
