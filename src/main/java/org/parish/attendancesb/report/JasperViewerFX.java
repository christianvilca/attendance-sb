...
public class JasperViewerFX extends Dialog<Void>{
    ...
    private BorderPane createContentPane() {
        btnPrint = new Button(null, new ImageView(getClass().getResource("/img/printer.png").toExternalForm()));
        btnSave = new Button(null, new ImageView(getClass().getResource("/img/save.png").toExternalForm()));
        btnBackPage = new Button(null, new ImageView(getClass().getResource("/img/backimg.png").toExternalForm()));
        btnFirstPage = new Button(null, new ImageView(getClass().getResource("/img/firstimg.png").toExternalForm()));
        btnNextPage = new Button(null, new ImageView(getClass().getResource("/img/nextimg.png").toExternalForm()));
        btnLastPage = new Button(null, new ImageView(getClass().getResource("/img/lastimg.png").toExternalForm()));
        btnZoomIn = new Button(null, new ImageView(getClass().getResource("/img/zoomin.png").toExternalForm()));
        btnZoomOut = new Button(null, new ImageView(getClass().getResource("/img/zoomout.png").toExternalForm()));

//        btnPrint = new Button(null);
//        btnSave = new Button(null);
//        btnBackPage = new Button(null);
//        btnFirstPage = new Button(null);
//        btnNextPage = new Button(null);
//        btnLastPage = new Button(null);
//        btnZoomIn = new Button(null);
//        btnZoomOut = new Button(null);
...
//            ExtensionFilter xls = new ExtensionFilter("Microsoft Excel 2007", "*.xls");
            ...
            chooser.getExtensionFilters().addAll(pdf, html, xml, xlsx);
